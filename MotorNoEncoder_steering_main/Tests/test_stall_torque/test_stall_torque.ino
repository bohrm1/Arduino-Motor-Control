...
#include "stall_torque_stress_test.h"
...
void setup() 
{
    ...
    Serial.print("Motor Stall Torque Testing");
    Serial.print("");
    delay(3000);
    Serial.print('Get ready to hold onto the motor!');
    delay(3000);
}

void loop() 
{
    stall_torque_stress_test(motor1, motor2, motor3, motor4);
}
